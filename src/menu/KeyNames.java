...
// This is an Adjusted version of JME's Class KeyNames
public class KeyNames {
    ...
    static {
        ...
        KEY_NAMES[KEY_NUMPADEQUALS] = "Numpad Equals";
 
        KEY_NAMES[KEY_NUMPADENTER] = "Numpad Enter";
 
        KEY_NAMES[KEY_NUMPADCOMMA] = "Numpad Period";
        ...
        KEY_NAMES[KEY_EQUALS] = "Equals";
 
        KEY_NAMES[KEY_LBRACKET] = "Left Bracket";
 
        KEY_NAMES[KEY_RBRACKET] = "Right Bracket";
        ...
        KEY_NAMES[KEY_PERIOD] = "Period";
 
        KEY_NAMES[KEY_SLASH] = "Forward Slash";
 
        KEY_NAMES[KEY_MULTIPLY] = "*";
 
        KEY_NAMES[KEY_ADD] = "+";
 
        KEY_NAMES[KEY_COLON] = "Colon";
 
        KEY_NAMES[KEY_UNDERLINE] = "_";
 
        KEY_NAMES[KEY_AT] = "At Sign";
