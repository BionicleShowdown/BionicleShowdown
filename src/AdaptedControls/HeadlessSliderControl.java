 ...
 */
@Deprecated
public class HeadlessSliderControl extends AbstractController implements HeadlessSlider {
  ...
  public void bind(
    ...
    if ("verticalSliderHeadless".equals(parameter.getProperty("name"))) {
      sliderView = new SliderViewVertical(this);
    } else if ("horizontalSliderHeadless".equals(parameter.getProperty("name"))) {
...
//  }
  ...
  private class SliderViewVertical implements SliderView {
    ...
    public SliderViewVertical(final HeadlessSlider slider) {
      this.slider = slider;
    }
    ...
    public void valueChanged(final float value) {
      if (element.getId() != null) {
        nifty.publishEvent(element.getId(), new HeadlessSliderChangedEvent(slider, value));
      }
    }
  }
  ...
  private class SliderViewHorizontal implements SliderView {
    ...
    public SliderViewHorizontal(final HeadlessSlider slider) {
      this.slider = slider;
    }
